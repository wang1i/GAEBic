...
from PGAE.optimizer import OptimizerAE, OptimizerVAE, OptimizerPAE
from PGAE.data_load import my_data_load
from PGAE.model import GCNModelPAE
from PGAE.preprocessing import preprocess_graph, construct_feed_dict, sparse_to_tuple, mask_test_edges
...
for epoch in range(FLAGS.epochs):
    ...
    if epoch == FLAGS.epochs - 1:
        np.savetxt("/data/mRNA embedding.txt", outs[3], fmt="%.5e")
